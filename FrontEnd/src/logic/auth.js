...
export default {
  ...
  editar(id,precio,nombre,description,stock,ProductoID,categories,img){
    const products = {id,precio,nombre,description,stock,ProductoID,categories,img};
    return axios.put(ENDPOINT_PATH + "/products/" + products.id, products);
  },
  find(name){
    //const category = {name};
